...
async function seed() {
  ...
  const chapter = await Chapter.findOne({ subject_id: subject._id, title: "Geometry Extensions" });
  if (!chapter) {
    console.error('Chapter "Geometry Extensions" not found — run seedMathAngleSpeedChallenge.js first.');
    process.exit(1);
  }
  console.log("Using existing chapter:", chapter._id);

  const concept = await Concept.findOne({ chapter_id: chapter._id, title: "Angle Relationships (Enrichment)" });
  if (!concept) {
    console.error('Concept "Angle Relationships (Enrichment)" not found — run seedMathAngleSpeedChallenge.js first.');
    process.exit(1);
  }
  ...
  const newRounds = [
    {
      ...
      payload: {
        ...
        questions: [
          { id: "q1", prompt: "Two angles on a straight line are 110\u00b0 and x. Find x.", options: [{ id: "a", label: "80\u00b0" }, { id: "b", label: "70\u00b0" }, { id: "c", label: "60\u00b0" }], correct_option_id: "b" },
          ...
          { id: "q3", prompt: "Two angles on a straight line are 65\u00b0 and x. Find x.", options: [{ id: "a", label: "105\u00b0" }, { id: "b", label: "125\u00b0" }, { id: "c", label: "115\u00b0" }], correct_option_id: "c" },
          { id: "q4", prompt: "Four angles around a point are 90\u00b0, 90\u00b0, 90\u00b0, and x. Find x.", options: [{ id: "a", label: "80\u00b0" }, { id: "b", label: "100\u00b0" }, { id: "c", label: "90\u00b0" }], correct_option_id: "c" },
          { id: "q5", prompt: "Two angles on a straight line are 148\u00b0 and x. Find x.", options: [{ id: "a", label: "42\u00b0" }, { id: "b", label: "32\u00b0" }, { id: "c", label: "22\u00b0" }], correct_option_id: "b" },
    ...
    },
    {
      ...
      payload: {
        ...
        questions: [
          { id: "q1", prompt: "Two lines cross, forming a 70\u00b0 angle on one side. Find the angle vertically opposite to it.", options: [{ id: "a", label: "110\u00b0" }, { id: "b", label: "70\u00b0" }, { id: "c", label: "20\u00b0" }], correct_option_id: "b" },
          ...
          { id: "q3", prompt: "Two lines cross, forming angles of 40\u00b0 and x next to each other on a straight line. Find x.", options: [{ id: "a", label: "40\u00b0" }, { id: "b", label: "50\u00b0" }, { id: "c", label: "140\u00b0" }], correct_option_id: "c" },
          { id: "q4", prompt: "Two lines cross, forming a 25\u00b0 angle. Find its vertically opposite angle.", options: [{ id: "a", label: "155\u00b0" }, { id: "b", label: "65\u00b0" }, { id: "c", label: "25\u00b0" }], correct_option_id: "c" },
          { id: "q5", prompt: "Two lines cross, forming angles of 162\u00b0 and x next to each other on a straight line. Find x.", options: [{ id: "a", label: "162\u00b0" }, { id: "b", label: "18\u00b0" }, { id: "c", label: "28\u00b0" }], correct_option_id: "b" },
